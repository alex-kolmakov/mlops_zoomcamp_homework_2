...
def run_data_prep(raw_data_path: str, dest_path: str, dataset: str = "green"):
    ...
    # Download the parquet files for January, February, and March
    urls = [
    ...
    filenames = [
        os.path.join(raw_data_path, "green_tripdata_2023-01.parquet"),
        os.path.join(raw_data_path, "green_tripdata_2023-02.parquet"),
        os.path.join(raw_data_path, "green_tripdata_2023-03.parquet")
    ]
